...
router.get('/apps/', function (req, res, next) {
  function paginate (apps) {
    const num = parseInt(req.query.num || String(DEFAULT_PAGE_SIZE));
    const start = parseInt(req.query.start || String(DEFAULT_START));
...
router.get('/apps/:appId/reviews',
  ...
  handleValidationErrors,
  function (req, res, next) {
    const opts = Object.assign({ appId: req.params.appId, country: req.query.country, num: parseInt(req.query.num) || DEFAULT_REVIEWS_COUNT }, req.query);
